<template>
   <div class="flex">
        ...
        <q-dialog v-model="showEditForm" persistent maximize='true'>
            <AdminChatFormEdit :propsEditData=propsEditData />
        </q-dialog>
        <q-dialog v-model="showAddForm" persistent>
            <AdminChatFormAdd />
        </q-dialog>
        <q-dialog v-model="showDeleteForm" persistent>
            <AdminChatFormDelete :propsDeleteData=propsDeleteData />
        </q-dialog>
...
import AdminChatFormAdd from 'src/forms/AdminChatForm/AdminChatFormAdd.vue';
import AdminChatFormEdit from 'src/forms/AdminChatForm/AdminChatFormEdit.vue';
import AdminChatFormDelete from 'src/forms/AdminChatForm/AdminChatFormDelete.vue';
import bus from 'src/utility/bus';

const columns = [
  { name: 'chatnumber', align: 'center', label: 'Chat Number', field: 'chatnumber', sortable: true },
  { name: 'inquiry', label: 'Inquiry', field: 'inquiry', sortable: true },
  { name: 'chatstatus', label: 'Chat Status', field: 'chatstatus', sortable: true },
  { name: 'chatby', label: 'Chat By', field: 'chatby', sortable: true },
