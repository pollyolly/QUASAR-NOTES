...
export default {
    ...
    setup(props){
        ...
        //const chatnumber = ref(props.propsEditData.chatnumber);
        const inquiry = ref(props.propsEditData.inquiry);
        const chatStatus = ref(props.propsEditData.chatstatus);
        const chatBy = ref(props.propsEditData.chatby);
        const onCancel = () => {
            Notify.create({
            ...
            bus.emit('closeEditForm', false, 'cancel');
        };
        const onSubmit = () => {
            Notify.create({
            ...
            bus.emit('closeEditForm', false, 'submit');
        };
        return {
            onSubmit, onCancel,
            inquiry,
